/*!
 * wavesurfer.js 2.0.0-beta01 (Mon Sep 18 2017 17:36:09 GMT-0500 (CDT))
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (function(modules) {
    ...
    /******/
    /******/ /******/ __webpack_require__.p = 'localhost:8080/dist/'; // Load entry module and return exports
    /******/
         ...
         */
          ...
          function WebAudio(params) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (WebAudio.__proto__ || Object.getPrototypeOf(WebAudio))
                .call(this),
            );
                ...
                return this.prepareDraw(
                  ...
                  function(_ref) {
                    ...
                    for (var i = 0; i < last; i += step) {
                      var h = Math.round(
                        peaks[Math.floor(i * scale)] / absmax * halfH,
                      );
                      _this4.fillRect(
                        i + _this4.halfPixel,
                        halfH - h + offsetY,
                      ...
                      // _this4.clearRect(i + _this4.halfPixel,i+offsetY+1,bar+ _this4.halfPixel+1,1); // just customize for your needs.
                    }
                  },
                );
              },
         ...
         */
            },
            {
              ...
              value: function getScrollX() {
                return Math.round(
                  this.wrapper.scrollLeft * this.params.pixelRatio,
                );
              },
